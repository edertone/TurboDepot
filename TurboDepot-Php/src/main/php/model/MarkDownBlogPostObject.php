...
class MarkDownBlogPostObject{
     ...
     *
     * Basically you should use this property when setting the metadata title field on a website post html page.
     *
    ...
    /**
     * An autogenerated description text that can be used as the html description metadata.
     */
