 ...
 */
class ObjectWithWrongForeignPropertiesDefined2 extends DataBaseObject{
    ...
    const FOREIGN_DELETE_OBJECTS = [
        ...
        'org\turbodepot\src\test\resources\managers\dataBaseObjectsManager\CustomerTypedForeignObject' => ['nonexistant' => 'customerId']
    ];
