...
export class TerminalManager {
     ...
     */
    exec(command: string, liveOutput = false, environmentVars:any = {}) {
        ...
        // load first all the process env variables
        let env:any = {};
        ...
        for(let key in environmentVars){
            
            env[key] = environmentVars[key];
        }
        ...
        if(liveOutput){
            ...
            try{
                ...
                output = this.execSync(finalCommand, {stdio:[0,1,2], env: env});
            ...
            try{
                ...
                output = this.execSync(finalCommand, {stdio : 'pipe', env: env}).toString();
